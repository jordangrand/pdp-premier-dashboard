...
df = df.drop(columns=["Last Name", "First Name", "BirthDate", "NAS CMJ Height",	"NAS Peak Power[W]", "NAS Peak Power BM[W/Kg]",	"AS CMJ Height", "AS Peak Power[W]", "AS Peak Power BM[W/Kg]"], errors="ignore")
